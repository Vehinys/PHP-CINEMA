...
<tr>
    ...
    foreach ($requete2->fetchAll() as $filmDetail) { ?>
        ...
        <tr>
            <td>
                <a href="index.php?action=detailFilm&id=<?= $filmDetail['id_film'] ?>"> <?= $filmDetail["titre"] ?> ( <?= $filmDetail["sortie"] ?> - <?= $filmDetail["age"] ?> ans )</a>
            </td>
            <td><?= $filmDetail["nomRole"] ?></td> <!-- Nom du rôle correspondant -->
...
$titre = "Film releases - Detail de l'acteur";
